...
from weraveyou.src.enrich.article_enricher import ArticleEnricher
from weraveyou.src.extraction.classifier import classify_article
from weraveyou.src.extraction.normalize import dedupe_releases
from weraveyou.src.extraction.parser import parse_release_candidate
from weraveyou.src.models import ReleaseCandidate
from weraveyou.src.scrapers.base import BaseScraper
from weraveyou.src.scrapers.weraveyou import WeRaveYouScraper

LOGGER = logging.getLogger(__name__)

SCRAPERS: dict[str, type[BaseScraper]] = {
    "weraveyou": WeRaveYouScraper,
}
