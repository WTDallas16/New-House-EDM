...
from weraveyou.src.extraction.parser import BODY_PATTERNS
from weraveyou.src.models import ArticleEnrichment
from weraveyou.src.scrapers.weraveyou import HEADERS
...
def _is_music_link(url: str) -> bool:
    ...
    if parsed.netloc.endswith("youtube.com") and path.startswith(("user/", "channel/", "c/")):
        return False
    if parsed.netloc.endswith("soundcloud.com") and path in {"weraveyou", "we-rave-you"}:
        return False
    return True
